  ...
  return (
    ...
    >
      <div className="max-w-[1200px] mx-auto px-8">
        <p
          className="max-w-[700px] mx-auto text-center text-base leading-relaxed mb-8"
          style={{ color: "var(--text-secondary)" }}
        >
          Instantly publish your packages and install them. Use the API to
          interact and find out more information about available packages.
          Become a contributor and enhance the site with your work.
        </p>

        {/* nargo add Installation Instructions */}
        <div
          className="max-w-[600px] mx-auto mb-12 p-6 rounded-lg"
          style={{
